...
const CartItemDetails = ({ product, handleRemoveDatabyID }) => {
    const { id, name, price, quantity, picture } = product;
    const handleRemoveData = (ID) => {
        handleRemoveDatabyID(ID);
    };
    return (
                ...
                <div className="flex flex-col justify-between w-full pb-4">
                    <div className="flex justify-between w-full pb-2 space-x-2">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-sm text-gray-600">Total: {price * quantity}$</p>
                        </div>
                    </div>
                    <div className="flex text-sm divide-x">
                        <button onClick={() => handleRemoveData(id)} type="button" className="flex items-center px-2 py-1 pl-0 space-x-1">
